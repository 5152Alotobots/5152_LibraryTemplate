...
public class SubSys_Shooter_Constants {
    ...
    public static final class ShooterArm {
        ...
        public static final class SoftwareLimits {
            ...
            public static final double SHOOTER_LIMIT_FORWARD = -.25; // Towards intake
    ...
    public static final class ShooterRoller{
        ...
        public static final double OpenLoopRampRate = 0.1; // seconds
    ...
    public static final class PID {
        ...
        static final class Arm {
            public static final double ARM_P = 90;
    ...
    public static final class Speeds {
        ...
        public static final double TRANSFER_INTAKE_SPEED = 0.6;
    ...
    public static final class AutoAim {
        ...
        public static final double SHOOTER_WAIT_AFTER_SHOOT = 0.1; // X seconds
        public static final double READY_TO_SHOOT_RPS = 55; // >85rps is ready to shoot
    }
    ...
    public static final class PresentArmPositions {
        ...
        public static final double ARM_PRESET_SPEAKER = -130.78;
    }
    ...
    public static final Pose2d SPEAKER_POSE_BLUE = new Pose2d(.35, 5.5, Rotation2d.fromDegrees(180));
    public static final Pose2d SPEAKER_POSE_RED = new Pose2d(16.2, 5.5, Rotation2d.fromDegrees(0));
    ...
    public static final PoseHashMap ANGLE_BY_DISTANCE_BLUE = new PoseHashMap(){{
        ...
        put(new Pose2d(1.15, 6.5, new Rotation2d()), -131.9); // right next to speaker, left
        put(new Pose2d(1.15, 4.4, new Rotation2d()), -131.9); // right next to speaker, right
        put(new Pose2d(2.8, 4.075, new Rotation2d()), -145.2); // just in front of rightmost close note
        put(new Pose2d(2.8, 5.43, new Rotation2d()), -145.2); // just in front of center close note
        put(new Pose2d(2.8, 6.78, new Rotation2d()), -145.2); // just in front of leftmost close note
        put(new Pose2d(2.325, 4.82, new Rotation2d()), -137.7); // In between right and center close note, center on white line
        put(new Pose2d(2.325, 6.15, new Rotation2d()), -137.53); // In between left and center close note, center on white line
        put(new Pose2d(1.9, 5.5, new Rotation2d()), -137.06); // In between center note and speaker, center on white line
        put(new Pose2d(1.9, 4.1, new Rotation2d()), -144.22); // In between right note and speaker, center on white line
        put(new Pose2d(1.9, 6.9, new Rotation2d()), -144.22); // In between left note and speaker, center on white line
    }};
