...
public class SubSys_Shooter extends SubsystemBase {
    ...
    private double shooterIdleSpeed;
    public void shooterIdleToggle() {
        if (shooterIdleSpeed == 0.0) {
            shooterIdleSpeed = 0.6;
        } else {
            shooterIdleSpeed = 0.0;
        }
    }
    ...
    public SubSys_Shooter () {
        ...
        shooterWheelsMtrLeftConfiguration.Slot0.kS = 0.13058;
        shooterWheelsMtrLeftConfiguration.Slot0.kA = 0.0090433;
