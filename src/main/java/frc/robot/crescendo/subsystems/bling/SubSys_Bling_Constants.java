...
public class SubSys_Bling_Constants {
    public static final double MAX_LED_BRIGHTNESS = .35;
    ...
    public static final class Animations {
        ...
        public static final RainbowAnimation RAINBOW_RAINBOW_ANIMATION = new RainbowAnimation(MAX_LED_BRIGHTNESS, 0.75, NUM_LEDS, false, 8);
