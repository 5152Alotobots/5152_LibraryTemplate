...
import static frc.robot.crescendo.subsystems.bling.SubSys_Bling_Constants.Animations.RAINBOW_RAINBOW_ANIMATION;
import static frc.robot.crescendo.subsystems.bling.SubSys_Bling_Constants.Animations.SHOOTING_ANIMATION;

public class Cmd_SubSys_Bling_RainbowRainbow extends Command {
    private final SubSys_Bling subSysBling;

    public Cmd_SubSys_Bling_RainbowRainbow(SubSys_Bling subSysBling) {
    ...
    public void initialize() {
        subSysBling.runAnimation(RAINBOW_RAINBOW_ANIMATION);
    }
