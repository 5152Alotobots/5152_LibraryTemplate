...
public class SubSys_Intake_Constants {
    public static final class IntakeArm {
        ...
        public static final double CLOSED_LOOP_RAMP_RATE = 0.2; // Seconds to full arm speed ramp
        public static final double CLOSED_LOOP_TARGET_VELOCITY = 1.2; // Rotations/s
    ...
    public static final class MaxSpeeds {
        public static final double MAX_ARM_ROTATION_SPEED = 0.6; //0.15;
        public static final double MAX_INTAKE_SPEED = -1;
        public static final double TRANSFER_SPEED = 0.4;
    }
    ...
    public static final class PresetIntakePositions {
        ...
        public static final double INTAKE_PRESET_PICKUP = 15;
    ...
    public static final class Limit {
        public static final double ARM_LIMIT_FORWARD = -0.0012; //-0.0112
        public static final double ARM_LIMIT_REVERSE = -0.4438;
