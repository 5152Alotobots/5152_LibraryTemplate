...
public class SubSys_Climber extends SubsystemBase {
  ...
  public void setClimberUp(){
    final VoltageOut requestVoltOut = new VoltageOut(0);
    climberLeftMtr.setControl(requestVoltOut.withOutput(12.0));
    climberRightMtr.setControl(requestVoltOut.withOutput(12.0));
  }

  public void setClimberDn(){
    final VoltageOut requestVoltOut = new VoltageOut(0);
    climberLeftMtr.setControl(requestVoltOut.withOutput(-12.0));
    climberRightMtr.setControl(requestVoltOut.withOutput(-12.0));
  }
  ...
  public void setClimberOff(){
    climberLeftMtr.set(0.0);
    climberRightMtr.set(0.0);
  }
}