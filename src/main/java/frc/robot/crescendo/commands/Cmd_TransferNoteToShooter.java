...
public class Cmd_TransferNoteToShooter extends SequentialCommandGroup {
  private final SubSys_Intake intakeSubSys;
  private final SubSys_Shooter shooterSubSys;

  public Cmd_TransferNoteToShooter(SubSys_Intake intakeSubSys, SubSys_Shooter shooterSubSys) {
